...
# 사용자 설정
DEPLOY_DIR="/media/sihokim/nvidia-poky/build-dashboard-jetson/tmp-glibc/deploy/images/jetson-orin-nano-devkit-nvme"  # deploy 디렉토리 위치
SYMLINK="customnux-image-jetson-orin-nano-devkit-nvme.rootfs.tegraflash.tar.gz"  # deploy 내의 심볼릭 링크 파일 이름
